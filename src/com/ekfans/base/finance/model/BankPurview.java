 ...
 */
public class BankPurview extends BasicBean {
	...
	private List<BankPurview> childList = new ArrayList<BankPurview>(); // 子权限集合
	...
	public List<BankPurview> getChildList() {
		return childList;
	}

	public void setChildList(List<BankPurview> childList) {
