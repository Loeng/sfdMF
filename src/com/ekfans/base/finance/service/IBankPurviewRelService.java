 ...
 * @version 1.0
 */
public interface IBankPurviewRelService {
	/**
	 * 
	 ...
	 * 
	 * @Title: modify
	 * @Description: TODO(根据roleId删除关联权限表的对应数据) 详细业务流程: (详细描述此方法相关的业务处理流程)
	 * @param roleId
	 * @return boolean 返回类型
	 * @throws
	 */
	 ...
	 * @Description: TODO(根据roleId得到集合) 详细业务流程: (详细描述此方法相关的业务处理流程)
	 * @param roleId
