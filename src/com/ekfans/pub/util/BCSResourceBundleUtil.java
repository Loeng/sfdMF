 ...
 * @version 1.0
 */
public class BCSResourceBundleUtil {
	// 定义资源束文件名
	private static String fileName = "/resources/bcsBank.properties";
	...
	static {
		...
		try {
			// 获取输入流
			InputStream in = BCSResourceBundleUtil.class.getResourceAsStream(fileName);
