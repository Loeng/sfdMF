package com.ekfans.pub.util.interceptor;
...
import com.ekfans.plugin.license.licenseTool;
...
public class LicenseInterceptor implements HandlerInterceptor {
	 ...
	 * @return
	 */
	private static boolean checkServerName(HttpServletRequest request) {
		// 获取域名信息
		String requestDomain = request.getServerName();
		// 调用方法校验license
		return licenseTool.checkLicenseStr(request, requestDomain);
	}
