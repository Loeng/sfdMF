...
public class StringUtil {
	...
	/**
     * 把JSONArray数组转换为指定格式的字符串  如 : dfsdf,fsdfs,fsdfs  or   fsdfs=fsdfs=fsdfsf
     * @param list
     * @param a
     * @return
     * @throws JSONException 
     */
	public static String arrayToString(JSONArray list,String a) throws JSONException{
		String str="";
		for(int i=0;i<list.length();i++){
			str=str+list.getString(i)+a;
		}
		return str;
	}
	/**
     * 把字符串集合转换为指定格式的字符串  如 : dfsdf,fsdfs,fsdfs  or   fsdfs=fsdfs=fsdfsf
     * @param list
     * @param a
     * @return
     * @throws JSONException 
     */
	public static String arrayToString(List<String> list,String a) throws JSONException{
		String str="";
		for(String s : list ){
			str=str+s+a;
		}
	 ...
	 * @return
	 */
	public static String sqlToLike(String str) {
		if (isEmpty(str)) {
			return str;
		}
