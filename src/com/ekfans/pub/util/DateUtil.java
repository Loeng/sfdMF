...
public class DateUtil {
	...
	public static String DATE_FORMAT_DATETIME_FULL = "yyyyMMddHHmmssSSS"; // 年/月/日

	public static String DATE_FORMATE_DATETIME_NEW = "yyyyMMddHHmmss";
	...
	public static SimpleDateFormat sdfDateTimeFull = new SimpleDateFormat(DateUtil.DATE_FORMAT_DATETIME_FULL);

	public static SimpleDateFormat dateTimeFullNew = new SimpleDateFormat(DateUtil.DATE_FORMATE_DATETIME_NEW);
	...
	/**
	 * 以YYYYMMDDHHmmssSSS格式返回系统日期时间
	 * 
	 * @return
	 */
	public static String getFullSysDateTimeString() {
		return toString(new java.util.Date(System.currentTimeMillis()), DateUtil.sdfDateTimeFull);
	}
	 ...
	 * @return
	 */
	public static String getFullSysDateTimeStringNew() {
		return toString(new java.util.Date(System.currentTimeMillis()), DateUtil.dateTimeFullNew);
	}
