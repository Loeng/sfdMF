package com.ekfans.plugin.webService.warehouse.util;

import org.springframework.web.context.ContextLoader;

import com.ekfans.plugin.cache.base.Cache;

public interface WareHouseSyncConst {
	// 资源磁盘路径
	...
	// 请求地址
	public static final String REQ_URL = Cache.getResource("house.url.prefx") + "/data/wareHouseSync";
	// 获取orgId
	...
	public static final String PUSH_FLAG = "housePushAllFlag";
	// 推送状态
