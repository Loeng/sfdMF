package com.ekfans.plugin.jiuding.utils;
...
public class StringMapUtil {
    ...
    public static Map<String, String> stringToDataFieldMap(String str) throws JSONException {
    ...
    public static Map<String, String> stringToErrorFieldMap(String str) throws JSONException {
   	   JSONObject jsonObject=new JSONObject(str);
   	   Map<String, JSONObject> map=(Map)jsonObject;
