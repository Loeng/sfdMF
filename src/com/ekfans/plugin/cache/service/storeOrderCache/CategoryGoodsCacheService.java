 ...
 */
public class CategoryGoodsCacheService implements ICategoryGoodsCacheService {

	@Override
	public List<CategoryGoods> getList() {
		ICategoryGoodsService categoryGoodsService=SpringContextHolder.getBean(ICategoryGoodsService.class);
		List<CategoryGoods> categotys = categoryGoodsService.getCategoryGoodsList();
		return categotys;
	}
