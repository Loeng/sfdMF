...
// 新增
function roleAdd(){
	window.location.href = $("#ctxpath").val() + "/system/role/add";
}
...
function roleModify(id){
	window.location.href = $("#ctxpath").val() + "/system/role/detail/" + id + "/1";
}

// 查看
function queryId(id){
	window.location.href = $("#ctxpath").val() + "/system/role/detail/" + id + "/2";
}
...
function roleDelete(id){
	var ctx = $("#ctxpath").val();
	$.post(ctx + "/system/role/delete", {ids:id}, function(data){
