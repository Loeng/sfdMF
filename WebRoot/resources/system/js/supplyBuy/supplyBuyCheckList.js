...
function storeAdd(ind){
	...
	window.location.href = $("#ctxpath").val() + "/system/supplyBuy/Add/"+productType;
}
...
// 点击修改按钮，根据id进行会员资料查询
function supplyBuyCheck(id){
	window.location.href = $("#ctxpath").val() + "/system/supplyBuy/query/" + id + "/3";
}
...
// 查询详情
function queryId(id){
	window.location.href = $("#ctxpath").val() + "/system/supplyBuy/query/" + id + "/2";
}
