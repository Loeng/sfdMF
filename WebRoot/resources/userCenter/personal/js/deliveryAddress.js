...
function myupreset(){
	window.location.href = $("#ctxpath").val() + "/user/deliveryAddress";
}
...
function newSetDefaultAddress(id){
	...
	$.post(ctxpath + "/user/setDefaultAddress/" + id, {udstatus:udstatus}, function(data){
...
function newDeleteUserAddress(id){
	...
	$.post(ctxpath + "/user/delete/" + id, {udstatus:udstatus}, function(data){
