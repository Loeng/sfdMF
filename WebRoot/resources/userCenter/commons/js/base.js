...
$(document).ready(function() {
	...
	var navofftop=$(".leftNav").offset().top;
	var offBottom=bodyHeight-navHeight-navofftop;
	var footerHeight=$(".footer").outerHeight();
	var scrollH;
	$(window).scroll(function(){
		scrollH = $(document).scrollTop();
		if(scrollH >= navofftop){
			$(".budong").addClass("fixed");
			if(offBottom-footerHeight<navHeight/2){
				//if(bodyHeight-scrollH-footerHeight<navHeight){
