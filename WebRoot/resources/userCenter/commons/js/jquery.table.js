        ...
        tablePaging: function (options) {
            ...
            $(this).each(function () {
                ...
                if (allPage > 1) {
                    ...
                    jQuery(queue).append('<p class="paging"><a id="prePage" tableid="' + jQuery(this).attr('id') + '" pageindex=' + (parseInt(jQuery(this).data("pageindex")) - 1) + ' href="#">previous</a> | ' + (parseInt(jQuery(this).data("pageindex")) + 1) + '/' + allPage + ' | <a id="nextPage" tableid="' + jQuery(this).attr('id') + '" pageindex=' + (parseInt(jQuery(this).data("pageindex")) + 1) + ' href="#">next</a></p>');
