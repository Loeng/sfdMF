...
// 订单列表的JS操作
function xxx(ctxpath,orderId,status,shippingStatus,userApp,actType,orderType){
	// 发送请求
	...
	document.write("<input type='hidden' name='actType' value='"+actType+"' />");
	document.write("<input type='hidden' name='orderType' value='"+orderType+"' />");
	document.write("</form>");
